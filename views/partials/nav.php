        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="rounded-md px-3 py-2 text-sm font-medium <?= $current_page === '/' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?>">Home</a>
                        <a href="/about" class="rounded-md px-3 py-2 text-sm font-medium <?= $current_page === '/about' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?>">About</a>
                        <a href="/contact" class="rounded-md px-3 py-2 text-sm font-medium <?= $current_page === '/contact' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?>">Contact Us</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
